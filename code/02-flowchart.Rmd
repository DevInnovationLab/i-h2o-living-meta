...
# TO DO
1) we include data from papers where the authors did not respond. need to show this in the flowchart - so it doesn't look like papers we include are a subset of papers with responses (I think, let's separate into 2 boxes and then connect back)
2) In the paper we make a distinction between studies reporting mortality in the paper, having mortality as an outcome, and having mortality data available through contacting authors. You could make it three bulletpoints under the general heading of "mortality data available"?
...
[1]: paste0('a.1) 2016-20: ', counts_2020$database, ' studies\\nidentified through\\ndatabase searching')
[2]: paste0('a.2) 2020: ', counts_2020$other_sources, ' studies from\\n', sources_text_2020)
[3]: paste0('a.1) 2020-25: ', counts_2025$database, ' studies\\nidentified through\\ndatabase searching')
...
[8]: paste0('c) ', counts_combined$full_text, ' studies with \\nfull text reviewed')
